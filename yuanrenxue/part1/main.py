...
headers = {
    ...
    # 'cookie': 'sessionid=rrmqn6k1hmuug5ohgqkbwz8y1s42rwqa; no-alert3=true; tk=3690198760962583646',
}



with open('./part1/main.js', 'r', encoding='utf-8') as f:
    js_code = f.read()
